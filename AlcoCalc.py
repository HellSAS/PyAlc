...
class AlcoCalc:
    ...
    def сalculate_alcohol_effect(c) -> dict:
        ...
        if c > AlcoCalc.IntoxicationLevel.intoxication_levels["трезвый"][0]:
                can_drive = False
                
        for i in AlcoCalc.IntoxicationLevel.intoxication_levels:
            if c < AlcoCalc.IntoxicationLevel.intoxication_levels[i][0]:
                intoxication_level = AlcoCalc.IntoxicationLevel.intoxication_levels[i]
                break
            else:
                intoxication_level = AlcoCalc.IntoxicationLevel.intoxication_levels["смертельное отравление"]
                can_drive = False
